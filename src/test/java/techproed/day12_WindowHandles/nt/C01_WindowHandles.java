package techproed.day12_WindowHandles.nt;
...
public class C01_WindowHandles extends TestBase {
    ...
    public void name() {
        ...
        // sayfa 1 handle degerini yazdir
        System.out.println(driver.getWindowHandles().toArray()[0].toString());
        // sayfa 2 handle degerini yazdir
